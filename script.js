...
{question: "Για κάθε συνάρτηση \\( f: A \\to \\mathbb{R} \\), όταν υπάρχει το όριο της f καθώς το \\(x\\) τείνει στο \\(x_{0} \\in A\\), τότε αυτό το όριο ισούται με την τιμή της f στο \\(x_{0}\\).", answer: false}
    ...
    'Συνέχεια': {
        ...
        {question: "Αν μια συνάρτηση \\( f \\) είναι συνεχής σε ένα διάστημα \\( \\Delta \\) και δεν μηδενίζεται σ' αυτό, τότε αυτή ή είναι θετική για κάθε \\( x \\in \\Delta \\) ή είναι αρνητική για κάθε \\( x \\in \\Delta \\), δηλαδή διατηρεί πρόσημο στο \\( \\Delta \\)","answer": true},
        ...
        {question: "Μια πολυωνυμική συνάρτηση \\( f: \\mathbb{R} \\to \\mathbb{R} \\) διατηρεί πρόσημο σε καθένα από τα διαστήματα στα οποία οι διαδοχικές ρίζες της ,  χωρίζουν το πεδίο ορισμού της .","answer": true},
