const quizData = {
    ...
    {question: "Μια συνάρτηση μπορεί να είναι γνησίως μονότονη σε ένωση διαστημάτων.", answer: true},
    {question: "Αν η f είναι γνησίως αύξουσα στο (-∞,3) και στο (5,+∞), τότε σίγουρα είναι γνησίως αύξουσα και στο (-∞,3)∪(5,+∞).", answer: false},
    {question: "Αν μια συνάρτηση f με πεδίο ορισμού Α έχει ολικό μέγιστο στο x₀ που ανήκει στο Α , τότε f(x₀) ≥ f(x) για κάθε x που ανήκει στο Α .", answer: true},
    {question: "Αν μια συνάρτηση f με πεδίο ορισμού Α έχει ολικό ελάχιστο στο x₀ που ανήκει στο Α , τότε f(x₀) ≤ f(x) για κάθε x που ανήκει στο Α .", answer: true},
    {question: "Αν η f έχει μέγιστο το 3, τότε η -f έχει ελάχιστο το -3.", answer: true},
    {question: "Αν μια συνάρτηση f είναι 1-1, τότε σε διαφορετικά x αντιστοιχίζονται διαφορετικές τιμές τησ f .", answer: true},
    ...
    {question: "Για να είναι μια συνάρτηση f με πεδίο ορισμού Α 1-1 , αρκεί να ισχύει ότι για οποιαδήποτε x₁,x₂ που ανήκουν στο Α , αν f(x₁)=f(x₂) τότε x₁=x₂.", answer: true},
