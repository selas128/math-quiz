const quizData = {
  ...
  {question: "Έστω η συνάρτηση \\( f: A \\to \\mathbb{R} \\) και \\( \\alpha, \\beta \\in A \\), τότε ισχύει \\( f(\\alpha) = f(\\beta) \\iff \\alpha = \\beta \\).", answer: false},
    ...
    {question: `Η γραφική παράσταση της \\(|f({x})|\\) αποτελείται από τα τμήματα της γραφικής παράστασης της f που βρίσκονται πάνω από τον άξονα x'x και από τα συμμετρικά, ως προς τον άξονα x'x, των τμημάτων της γραφικής παράστασης της f που βρίσκονται κάτω από τον άξονα x'x.`, answer: true},
