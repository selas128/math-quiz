...
{question: "Για κάθε συνάρτηση \\( f: A \\to \\mathbb{R} \\), όταν υπάρχει το όριο της f καθώς το \\(x\\) τείνει στο \\(x_{0} \\in A\\), τότε αυτό το όριο ισούται με την τιμή της f στο \\(x_{0}\\).", answer: false}
    ...
    'Συνέχεια': {
        ...
        trueFalse: [
            {question: "Αν μια συνάρτηση \\( f \\) είναι γνησίως φθίνουσα και συνεχής σε ένα ανοικτό διάστημα \\( (\\alpha, \\beta) \\), τότε το σύνολο τιμών της στο διάστημα αυτό είναι το διάστημα \\( (A, B) \\), όπου \\( A = \\lim_{x \\to \\alpha^{+}} f(x) \\) και \\( B = \\lim_{x \\to \\beta^{-}} f(x) \\)","answer": true},
    ...
    'Παράγωγος': {
        ...
        {question: " Αν  μια  συνάρτηση \\(f\\) είναι δυο φορές παραγωγίσιμη  στο \\(x_0\\) τότε η \\(f^{\\large\\prime}\\) ειναι συνεχής στο \\(x_0\\) ." , answer:true},
      ...
      {question: "Αν η συνάρτηση \\( f \\) είναι παραγωγίσιμη στο \\( \\mathbb{R} \\) και δεν είναι αντιστρέψιμη, τότε υπάρχει κλειστό διάστημα \\([a,b]\\), στο οποίο η \\( f \\) ικανοποιεί τις προϋποθέσεις του θεωρήματος Rolle.", answer: false},

       {question: "Κάθε συνάρτηση \\( f \\), για την οποία ισχύει \\( f′(x)=0 \\) για κάθε \\( x \\in (a,x_{0}) \\cup (x_{0},\\beta) \\), είναι σταθερή στο \\((a,x_{0}) \\cup (x_{0},\\beta)\\).", answer: true},
...
{question: "Αν η συνάρτηση \\( f \\) είναι συνεχής στο \\( [\\alpha, \\beta] \\)  παραγωγίσιμη στο \\( (\\alpha, \\beta) \\) και \\( f(\\alpha)=f(\\beta) \\), τότε υπάρχει ένα τουλάχιστον  \\( \\x_0 \\in (\\alpha, \\beta) \\) ώστε η εφαπτομένη της γραφικής παράστασης της \\( f \\) στο \\( M(\\x_0, f(\\x_0)) \\) να είναι παράλληλη στον άξονα x'x.",answer: true},
{question : "Αν η συνάρτηση \\( f \\) είναι παραγωγίσιμη στο \\( [\\0, \\1] \\) και \\( f′(x)\\neq 0 \\) τότε υπάρχει ένα τουλάχιστον \\( \\x_0 \\in (\\0, \\1) \\) τέτοιο ώστε \\( f′(x)=0 \\) .", answer: true},
